---
title: "BiasFreeEnrich Related Analysis"
...
#Import
```{r Import}
#If you have downloaded all 3 folders and have them in the same folder as this .Rmd file then this code will import all of the data required for analysis into the R environment. 

# List of folders to Import
folders <- c("Processed Data", "Raw Data", "Re-analysed Data")

# Loop
for (folder in folders) {
  excel_files <- list.files(path = folder, pattern = "\\.xlsx$", full.names = TRUE)
...
##Liver Synthetic 
```{r Statistical analysis of Liver Synthetic}
...
```
##Yang et al. 
```{r Statistical analysis of Yang et al.}
...
```
##Lin et al.
```{r Statistical analysis of Liver Lin et al.}
...
```
##Synthetic Liver
```{r Analysis of Published Synthetic Liver data}
#BiasFreeEnrich (BFE)
  set.seed(200)
  #BG
...
###Yang et al.
```{r Analysis of Published Yang et al. data}
#List of DEPs fron Yang et al. retrieved from Supplemental table S6 titled 'Summary of differentially expressed proteins in RCVS’ 
Yang_Sig <- mmc6_250
...
```
###Lin et al. 
```{r Analysis of Published Lin et al. data}
#List of DEPs fron Lin et al. retrieved from Supplemental table S2 titled 'ANOVA_significant_282 proteins’ 
Lin_Sig <- Sup.Table.S2...ANOVA_significant_282.proteins
...
###Yang et al.
```{r Re-analysis of Raw Yang et al. data}
#BFE
  set.seed(200)
  #BG
...
```
###Lin et al. 
```{r Re-analysis of Raw Lin et al. data}
#BFE
  set.seed(200)
  #BG
...
```{r Data frame export for supplemental tables}
